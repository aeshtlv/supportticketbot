    ...
    try:
        async with get_db().session_factory() as session:
            ...
            if ticket:
                ...
                await message.answer(
                    "✅ Ваше сообщение получено. Мы постараемся ответить в ближайшее время.\n\n"
                    "💡 Вы можете дополнить свой запрос новым сообщением."
                )
                ...
                if last_ticket and last_ticket.status == TicketStatus.CLOSED and last_ticket.topic_id:
                    ...
                    await message.answer(
                        "✅ Ваше обращение переоткрыто. Ваше сообщение получено.\n\n"
                    ...
                    try:
                        ...
                        await message.answer(
                            "✅ Ваше обращение зарегистрировано. Ваше сообщение получено.\n\n"
                            "⏰ Мы постараемся ответить в ближайшее время.\n\n"
                            "💡 Вы можете дополнить свой запрос новым сообщением."
                        )
